...
class op(bpy.types.Operator):
	bl_idname = "uv.ttmini_color_select_vertex"
...
def select_color(self, context, index):
	...
	layer = mini_color.get_color_layer(obj.data)
	if layer is None:
	...
	target_color = list(mini_color.get_color(index))
	...
	threshold = bpy.context.scene.ttmini_settings.vertex_color_threshold
